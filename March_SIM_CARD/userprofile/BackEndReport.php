                       ...
                       if($fileError === 0){
                         if($fileSize<20000000){
                           ...
                           if(!mysqli_stmt_prepare($stmt,$sql)){
                                header("Location:../profile-user.php?reportPage&ReportStatus=connectionerror1");
                              }else{
                                ...
                                if(!mysqli_stmt_prepare($stmt,$sql)){
                                  header("Location:../profile-user.php?reportPage&ReportStatus=connectionerror2");
                                }else{
                                  //uploading the Data
                              ...
                              header("Location:../profile-user.php?reportPage&ReportStatus=FileLarge");
                              exit();
                            }
                          }else{
                            header("Location:../profile-user.php?reportPage&ReportStatus=FileError");
                            exit();
                          }
                     }else{
                       header("Location:../profile-user.php?reportPage&ReportStatus=FileFormat");
                       exit();
                     }
                   } //line 60 end
                 } //line 55 end
